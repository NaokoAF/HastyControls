...
internal class AbilitySlomoPatch : IHastyPatch
{
	private static readonly FieldInfo playerField =
		typeof(Ability_Slomo).GetField("player", BindingFlags.Instance | BindingFlags.NonPublic)!;

	private static readonly FieldInfo currentlyActiveField =
		typeof(Ability_Slomo).GetField("currentlyActive", BindingFlags.Instance | BindingFlags.NonPublic)!;
