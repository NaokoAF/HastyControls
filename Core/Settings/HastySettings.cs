...
public static class HastySettings
{
	...
	public class GyroSpaceSetting() : HastyEnumSetting<GyroSpace>(Category, "Gyro Space", GyroSpace.PlayerTurn);
	public class GyroButtonSetting() : HastyEnumSetting<ControllerButton>(Category, "Gyro Button", ControllerButton.RightStick);
	public class GyroButtonModeSetting() : HastyEnumSetting<GyroButtonMode>(Category, "Gyro Button Mode", GyroButtonMode.Off);
	...
	public class GyroSensitivityRatioSetting() : HastyFloatSetting(Category, "Gyro Sensitivity Ratio", 0f, 5f, 1f);
	public class GyroTighteningSetting() : HastyFloatSetting(Category, "Gyro Tightening", 0f, 15f, 1f);
	public class GyroSmoothingThresholdSetting() : HastyFloatSetting(Category, "Gyro Smoothing Threshold", 0f, 400f, 25f);
	...
	public class RumbleIntensitySetting() : HastyFloatSetting(Category, "Rumble Intensity", 0f, 1f, 1f);
	public class RumbleOnDamageSetting() : HastyFloatSetting(Category, "Rumble on Damage Intensity", 0f, 1f, 1f);
	public class RumbleOnLandSetting() : HastyFloatSetting(Category, "Rumble on Land Intensity", 0f, 1f, 1f);
	public class RumbleOnFastRunSetting() : HastyFloatSetting(Category, "Rumble on Fast Run Intensity", 0f, 1f, 1f);
	public class RumbleOnSparkPickupSetting() : HastyFloatSetting(Category, "Rumble on Spark Pickup Intensity", 0f, 1f, 1f);
	public class RumbleOnBoostRingSetting() : HastyFloatSetting(Category, "Rumble on Boost Ring Intensity", 0f, 1f, 1f);
	public class RumbleOnBoardBoostSetting() : HastyFloatSetting(Category, "Rumble on Board Boost Intensity", 0f, 1f, 1f);
	public class RumbleOnGrappleSetting() : HastyFloatSetting(Category, "Rumble on Grapple Intensity", 0f, 1f, 1f);
	public class RumbleOnFlySetting() : HastyFloatSetting(Category, "Rumble on Poncho Intensity", 0f, 1f, 1f);
